#ifndef _BA_SFM_BUNDLE_ADJUSTMENT_BA_NAIVE_GRADIENT_INFINITE_NORM_CALCULATOR_HPP_
#define _BA_SFM_BUNDLE_ADJUSTMENT_BA_NAIVE_GRADIENT_INFINITE_NORM_CALCULATOR_HPP_
